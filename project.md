...
- **Подзадача C1.1**: HTML/CSS/JS страница с формой ввода ника.
  ...
  - **Затронутые модули:** `src/main/resources/static/**` (предполагаемое место).
  - **Подход:** простой SPA без фреймворка или с небольшим UI-библиотекой.
